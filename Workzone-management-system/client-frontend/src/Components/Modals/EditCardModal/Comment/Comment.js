...
const Comment = (props) => {
	...
	const handleSaveClick = async () => {
		setEdit(true);
		await commentUpdate(workspaceId, card.cardId, card.listId, card.boardId, comment, props._id, dispatch);
	};

	const handleDeleteClick = async () => {
		await commentDelete(workspaceId, card.cardId, card.listId, card.boardId, props._id, dispatch);
	};
	return (
		<>
			<Container>
