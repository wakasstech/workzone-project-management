...
const PhotosMenu = (props) => {
	...
	const handleClick = (background) => {
		boardBackgroundUpdate(workspaceId, props.boardId, background, true, props.dispatch);
	};
...
const ColorsMenu = (props) => {
	...
	const handleClick = (background) => {
		boardBackgroundUpdate(workspaceId, props.boardId, background, false, props.dispatch);
	};
