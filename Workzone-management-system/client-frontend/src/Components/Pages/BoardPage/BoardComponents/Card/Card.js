...
const Card = (props) => {
  ...
  return (
    <>
      <Draggable draggableId={String(props.info._id)} index={props.index}>
        {(provided, snapshot) => {
          return (
            <Container
                      ...
                      {card?.members &&
                        card?.members?.map((member, i) => {
                          if (member) {
                            return (
                              ...
                              <Avatar
                                ...
                                sx={{
                                  width: 28,
                                  height: 28,
                                  bgcolor: member?.color || "defaultColor", // Provide a default color if member.color is undefined
                                  fontSize: "0.875rem",
                                  fontWeight: "800",
                                }}
                              >
                            ...
                            return null; // Return null if member is undefined
                          }
                        })}
                    </MembersWrapper> 
      ...
      {/* <button onClick={handleShow}>Card Internal</button> */}
    </>
  );
};
